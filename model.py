...
class PlayerData:
    ...
    team: str
    score: int = 0
    has_baseIcon: bool = False #Just Checks to see does this player have a base icon next to thier name
...
if __name__ == "__main__":
    gs = Game_State()
    print("This model works. Yay! The game is currrently in the ", gs.phase, " phase.")
